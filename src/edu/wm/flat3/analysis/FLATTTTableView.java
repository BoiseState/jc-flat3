...
public class FLATTTTableView extends ViewPart  implements IShowInTarget,IShowInSource  {
	...
	private void createTableSorter() {
		...
		sorter = new FLATTTTableViewSorter(
				...
				new ViewerSorter[] {comp.getNameComparator(), 
						comp.getNameComparator(), 
						comp.getProbabilityComparator(),
						comp.getMarkComparator(), 
						comp.getFullyQualifiedNameComparator(), comp.getNameComparator()},
				viewer.getTable()
				);
